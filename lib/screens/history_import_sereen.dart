...
class HistoryImportScreen extends StatefulWidget {
  const HistoryImportScreen({Key? key}) : super(key: key);

  @override
  State<HistoryImportScreen> createState() => _HistoryImportScreenState();
}
    ...
    return Container(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (context, int index) {
            return CustomListViewTilesHistoryImport(
                title: '2022/07/31 20:34',
                subtitle: 'ນ້ຳສົ້ມ',
          ...
          Row(
            ...
            children: [
              ...
              Column(
                children: [
                  SmallText(
                    text: '1,000,000,000,000 ກີບ',
                    color: Colors.black,
                    size: 15,
                  ),
                  SmallText(
                    text: 'ກຳໄລ:1,000,000 ກີບ',
                    color: Colors.green,
                    size: 14,
                  ),
                ],
